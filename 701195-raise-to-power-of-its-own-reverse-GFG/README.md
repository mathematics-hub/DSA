...
## Medium
Given a number n, find the value of n raised to the power of its own reverse.&nbsp;The result will always fit into a 32-bit signed integer.Examples:Input: n = 2Output: 4

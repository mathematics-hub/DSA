# [Swap kth elements](https://www.geeksforgeeks.org/problems/swap-kth-elements5500/1?page=10&category=Arrays&sortBy=submissions)
## Easy
...
Constraints:1 ≤ arr.size(), k ≤ 106-109 ≤ arr[i] ≤ 109
# [Find unique element](https://www.geeksforgeeks.org/problems/find-unique-element2632/1)
## Easy
...
Expected Time Complexity: O(n* log(arr[i]))Expected Auxiliary Space: O(log(arr[i]))
Constraints:3&lt;= arr.size()&lt;=2*1052&lt;= k&lt;=2*1051&lt;= arr[i]&lt;=109
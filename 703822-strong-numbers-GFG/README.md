...
## Easy
A Strong Number is a number whose value is equal to the sum of the factorials of its digits.Given a positive integer n, find if it is a Strong Number.Examples:Input: 145
Output: true

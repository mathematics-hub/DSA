# [Count zeros in a sorted matrix](https://www.geeksforgeeks.org/problems/count-zeros-in-a-sorted-matrix/1)
## Easy
...
Examples:
Input: mat[][] = [[0,0,0], [0,0,1], [0,1,1]] Output: 6
Explanation: 
The first, second and third row contains 3, 2 and 1
zeroes respectively.
Input: mat[][] = [[1,1], [1,1]] Output: 0
Explanation:
There are no zeroes in any of the rows.
Constraints0 &lt; n ≤ 1030 ≤ mat[i][j] ≤ 1